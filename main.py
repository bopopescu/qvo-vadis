...
routes = [
    ...
    webapp2.Route(r'/<edit_mode:new>/<latitude:-?\d+\.\d+>%2c<longitude:-?\d+\.\d+>%2c<zoom:\d+>z', handler='edit.EditHandler'),
    webapp2.Route(r'/<edit_mode:new>/<latitude:-?\d+\.\d+>%2c<longitude:-?\d+\.\d+>%2c<zoom:\d+>z/<tags:[^/]+>', handler='edit.EditHandler'),
    webapp2.Route(r'/<edit_mode:new>/<latitude:-?\d+\.\d+>%2c<longitude:-?\d+\.\d+>%2c<zoom:\d+>z/hash/<hashtags:[^/]+>', handler='edit.EditHandler'),
    webapp2.Route(r'/<edit_mode:new>/<latitude:-?\d+\.\d+>%2c<longitude:-?\d+\.\d+>%2c<zoom:\d+>z/<tags:[^/]+>/hash/<hashtags:[^/]+>', handler='edit.EditHandler'),
